...
## Why is a CIDR Calculator Important? 
  * Allows for efficient ip address planning (preventing ip addresses from overlapping)
...
# Checklist
    [x] create a function to allow users to input CIDR block and number of subnets
        [x] Add validations to ensure only valid CIDR notations are entered in
